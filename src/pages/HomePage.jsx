          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {MOCK_REVIEWS.map((review, i) => (
              <motion.div 
                ...
                viewport={{ once: true }}
                className="bg-slate-50 rounded-[2.5rem] p-8 relative hover:bg-white hover:shadow-2xl transition-all border border-slate-100"
              >
                <div className="absolute top-8 right-8 text-amber-400 flex">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <motion.div 
              ...
              className="bg-white/5 backdrop-blur-md rounded-[2.5rem] p-8 border border-white/10"
            >
              <h3 className="font-be-vietnam font-black text-amber-500 mb-6 text-xl">Dự báo Gen AI (Gemini 2.0)</h3>
              <div className="space-y-4">
                {[
